        ...
        <div className="position-relative py-3 mx-auto">
          ...
          <div className="position-relative p-4 py-10 bg-white shadow-lg rounded-3">
            <div className="w-100 mx-auto">
              <h1 className="fs-2 fw-semibold mb-4 text-center">Modificar pelicula</h1>
                <h4 className="fs-2 fw-semibold mb-4 text-center"> Ingresa el título de la pelicula que quieras modificar y el dato que desees actualizar </h4>
              <Formik
                initialValues={{
                  title: '',
                  year: '',
                ...
                onSubmit={async (values, { setSubmitting, resetForm }) => {
                  try {
                    const response = await axios.put("http://localhost:3001/movies/update", values, {
                        headers: {
